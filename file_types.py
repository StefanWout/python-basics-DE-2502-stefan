...
new_file_path = current_dir / 'TRAINER_DEMO_FILES' / 'new_data.csv'
...
new_tsv_file_path = current_dir / TRAINER_DEMO_FILES / FILE_NAME[2]

with open(new_tsv_file_path) as tsv_file:
